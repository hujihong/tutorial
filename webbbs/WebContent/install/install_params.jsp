  ...
  <tr>
    <td height="400" align="center" bgcolor="#F0F8FD"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="left"><input name="dbName" type="text" class="input" id="dbName" value="jeebbs4" /></td>
				<td align="left">&nbsp;</td>
      </tr>
      <tr>
...
<input type="hidden" name="dbFileName" value="/install/db/jeebbs-db-4.sql"/>
<input type="hidden" name="initFileName" value="/install/db/jeebbs-db-init-v4.sql" />
</form>
</body>
</html>
